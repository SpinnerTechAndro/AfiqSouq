...
public class SharedPrefManager {
    ...
    private  static  final String  NOTTIFICATION = "notification";
    ...
    public boolean getNottificationStatus() {
        SharedPreferences sharedPreferences = mCtx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
        boolean token = sharedPreferences.getBoolean(NOTTIFICATION, true);

        return token;
    }
    public void setNottificationStatus(boolean state) {

        SharedPreferences sharedPreferences = mCtx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();

        editor.putBoolean(NOTTIFICATION, state);
