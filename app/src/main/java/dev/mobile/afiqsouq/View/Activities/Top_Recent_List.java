...
import dev.mobile.afiqsouq.Adapter.ProductListAdapter;
    ...
    public void loadAllPopularProducts(String type) {
        ...
        if(type.equals("RECENT")){
            ...
            popularProduct = RetrofitClient.getInstance()
                    .getApi()
                    .getAllRecentProducts(authHeader  , 50);
        }
        else {
        ...
        popularProduct.enqueue(new Callback<List<ProductModel>>() {
            ...
            public void onFailure(Call<List<ProductModel>> call, Throwable t) {
                Toasty.error(getApplicationContext(), "Something Went Wrong !! " + t.getMessage(), Toasty.LENGTH_LONG).show();
            }
        });
