...
public class HorizontralCateGoryAdapter extends RecyclerView.Adapter<HorizontralCateGoryAdapter.ViewHolder> {
    ...
    public HorizontralCateGoryAdapter(Context context, List<CategoryResp> list, ItemClickListener itemClickListener) {
